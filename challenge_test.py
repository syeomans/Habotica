...
groupId = party
response = challenge.createChallenge(sam, groupId, "AALiCE's Challenge", "AALiCE's Challenge", summary = "I learned how to create a challenge with the API!", description = "This will be taken down shortly. If you see this, please message me immediately.")
